...
class Wire():
    ...
    def integrate_electric_field(self,  particles: list[PointParticle], electric_field: np.ndarray[np.float64]) -> np.float64:
        pass
    ...
    def apply_electric_field(self, particles: list[PointParticle], electric_field: np.ndarray[np.float64]) -> None:
        pass
