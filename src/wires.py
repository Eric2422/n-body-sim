...
class Wire():
    ...
    def get_magnetic_field(self, field_point: vectors.PositionVector) -> vectors.FieldVector:
    ...
    def apply_magnetic_field(self, magnetic_field: Callable[[vectors.PositionVector], vectors.FieldVector]) -> None:
