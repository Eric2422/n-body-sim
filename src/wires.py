...
class Wire():
    ...
    def get_electromotive_force(self, electric_field: Callable[[vectors.PositionVector], vectors.FieldVector]) -> np.float64:
        """Calculate the electromotive force(emf) generated across the wire.

        Parameters
        ----------
        electric_field : Callable[vectors.PositionVector], vectors.FieldVector]
    ...
    def get_current(self, electric_field: Callable[[vectors.PositionVector], vectors.FieldVector]) -> np.float64:
        """Calculate the current flowing through this wire.

        Parameters
        ----------
        electric_field : Callable[[vectors.PositionVector]]
            A function that returns the electric field at any given point.
    ...
    def get_magnetic_field(self, field_point: vectors.PositionVector, electric_field: Callable[[vectors.PositionVector], vectors.FieldVector]) -> vectors.FieldVector:
    ...
    def apply_magnetic_field(self, magnetic_field: Callable[[vectors.PositionVector], vectors.FieldVector], electric_field: Callable[[vectors.PositionVector], vectors.FieldVector]) -> None:
        """Apply a magnetic force to the wire based on a magnetic field.

        Parameters
        ----------
        magnetic_field : Callable[[vectors.PositionVector], vectors.FieldVector]
